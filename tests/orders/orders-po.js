function clickOnLink() {
 ...
 function checkOrders() {
    ...
    browser.wait(EC.urlContains('https://qa.cbancnetwork.com/education/orders/my_orders'), 5000);
    browser.sleep(2000);
}
...
function checkOrdersPageTitle(){
    ...
    browser.wait(EC.titleIs('CBANC: My Orders'), 5000);
}

function checkTitleOnPage(){
    var EC = protractor.ExpectedConditions;
    //  Provera da li se ucitao page title
    browser.wait(EC.textToBePresentInElement($('.header_meta'), 'Order History'), 5000);
}
