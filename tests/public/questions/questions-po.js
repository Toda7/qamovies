...
function checkQuestionsPageTitle(){
    ...
    browser.wait(EC.titleIs('Discussions, Useful Answers, and Professional Banking Information to Answer Your Questions from Real Bankers'), 7000);
}
function checkButton(){
    var EC = protractor.ExpectedConditions;
    // Provera da li se ucitao button
    browser.wait(EC.textToBePresentInElement($('.sidebar_box'), 'New to CBANC'), 7000);
}
