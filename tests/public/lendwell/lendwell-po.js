...
function checkForm(){
    ...
    browser.wait(EC.textToBePresentInElement($('#request_form'), 'Contact us to learn more'), 7000);
}
function checkPSbox(){
    var EC = protractor.ExpectedConditions;
    // Provera da li se ucitao Integrated Products and Services box
    browser.wait(EC.textToBePresentInElement($('.middle_section'), 'Integrated Products and Services'), 7000);
    browser.sleep(2000);
}    
