...
browser.wait(EC.textToBePresentInElement($('.message.message-error.error'), 'Some of the items are unavailable to ship to Minnesota, California or New Jersey'), 5000);
}
