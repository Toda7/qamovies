...
function checkNumberOfItems(){
   ...
   browser.wait(EC.textToBePresentInElement($('.toolbar-amount'), '13 Items'), 7000);
   browser.sleep(2500);
}
...
function checkShowPerPageRL() {
   ...
   var EC = protractor.ExpectedConditions;
   browser.wait(EC.urlContains('https://shop.outfitterextreme.com/truglo/firearm-hunting.html?product_list_limit=24'), 7000);
}
...
function checkNumberOfItemsForShow9PerPage(){
   ...
   browser.wait(EC.textToBePresentInElement($('.toolbar-amount'), 'Items 1-9 of 13'), 7000);
   browser.sleep(2500);
}
...
function checkShow9PerPageRL() {
   ...
   var EC = protractor.ExpectedConditions;
   browser.wait(EC.urlContains('https://shop.outfitterextreme.com/truglo/firearm-hunting.html?product_list_limit=9'), 7000);
}
