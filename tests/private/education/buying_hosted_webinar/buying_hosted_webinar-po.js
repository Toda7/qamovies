...
function enterNumbersInCreditCardField() {
    ...
    element(by.xpath('//*[@id="main"]/div/div/div[2]/aside/div/div/form/div[1]/input')).sendKeys('4111111111111111');
    browser.sleep(2000);
}
function enterNameOfCreditCard() {
    //  Enter name of credit card field
    element(by.xpath('//*[@id="main"]/div/div/div[2]/aside/div/div/form/div[2]/input')).sendKeys('Testing');
    browser.sleep(2000);
}
...
function enterNumbersInZipField() {
    ...
    element(by.xpath('//*[@id="main"]/div/div/div[2]/aside/div/div/form/div[3]/div[2]/input')).sendKeys('12345');
    browser.sleep(2000);
}
