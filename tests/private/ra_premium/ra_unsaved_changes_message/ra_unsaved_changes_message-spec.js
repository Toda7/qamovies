...
var ra_unsaved_changes_message = require('./ra_unsaved_changes_message-po');
...
it('Klik n Discard Changes button', function(){
    ra_unsaved_changes_message.clickOnDiscardChanges();
});
...
it('Provera da li se text nije promenio nakon sto smo kliknuli na discard changes', function(){
    ra_unsaved_changes_message.checkIsAnswerNotEdited();
});
