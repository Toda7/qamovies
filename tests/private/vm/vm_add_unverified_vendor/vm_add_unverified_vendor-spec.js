...
var vm_add_unverified_vendor = require('../vm_add_unverified_vendor/vm_add_unverified_vendor-po.js');


describe('Add unverified vendor profile in VM', function(){
...
it('Klik na ADD UNVERIFIED VENDOR button', function(){
    vm_add_unverified_vendor.clickOnAddVendorButton();
});

it('Provera Fifa Vendor name kada na vendor details page', function(){
    vm_add_unverified_vendor.checkNameOfVendorOnVendorDetails();
});
