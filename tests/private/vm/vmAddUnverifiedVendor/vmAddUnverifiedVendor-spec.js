...
var vmAddUnverifiedVendor = require('../vmAddUnverifiedVendor/vmAddUnverifiedVendor-po.js');
...
it('Klik na ADD UNVERIFIED VENDOR button', function(){
    vmAddUnverifiedVendor.clickOnAddVendorButton();
});

it('Provera Fifa Vendor name kada na vendor details page', function(){
    vmAddUnverifiedVendor.checkNameOfVendorOnVendorDetails();
});
