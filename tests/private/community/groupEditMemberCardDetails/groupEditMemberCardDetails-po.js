...
function checkUserProfileURL() {
    ...
    browser.wait(EC.urlContains('https://qa.cbancnetwork.com/community/users/view/cbff5667-1260-43c4-9741-0648ea6ea792'), 7000);
 }
 ...
 function checkUserBankURL() {
    ...
    var EC = protractor.ExpectedConditions;
    browser.wait(EC.urlContains('https://qa.cbancnetwork.com/community/fis/view/90e52cd6-6cfa-498d-b356-f230b8d43a56'), 7000);
 }
