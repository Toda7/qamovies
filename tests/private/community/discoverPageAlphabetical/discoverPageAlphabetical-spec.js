...
it('Provera prve Topic kartice', function(){
    discoverPageAlphabetical.checkFirstTopicCard();
});

it('Provera druge Topic kartice', function(){
    discoverPageAlphabetical.checkSecondTopicCard();
});

it('Provera trece Topic kartice', function(){
    discoverPageAlphabetical.checkThirdTopicCard();
});
