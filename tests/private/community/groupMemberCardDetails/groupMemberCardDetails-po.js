...
function checkUserProfileURL() {
    ...
    browser.wait(EC.urlContains('https://qa.cbancnetwork.com/community/users/view/18cbe542-b2dc-4c9c-9217-4f356147e9ac'), 5000);
 }
...
function checkUserBankURL() {
    ...
    var EC = protractor.ExpectedConditions;
    browser.wait(EC.urlContains('https://qa.cbancnetwork.com/community/associations/view/bcee7945089f13b76ce5d9b9e59d5a73'), 5000);
 }
